...
from app.models.schemas import PostCreate, PostResponse, PostResponseWithVotes
...
def read_post(post_id: int, db: Session = Depends(get_db), current_user: dict = Depends(get_current_user)):
