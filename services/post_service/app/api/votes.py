...
from app.models.models import Vote, Post
from app.models.schemas import VoteCreate
...
def vote(vote: VoteCreate, db: Session = Depends(get_db), current_user: dict = Depends(get_current_user)):
